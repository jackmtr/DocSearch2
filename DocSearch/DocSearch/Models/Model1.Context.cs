...
namespace DocSearch.Models
{
    ...
    public partial class WASEntities : DbContext
    {
        ...
        public virtual int WSP_GetDocument_ID_Opt(ObjectParameter nArKey, ObjectParameter bComplete, ObjectParameter zMessage)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WSP_GetDocument_ID_Opt", nArKey, bComplete, zMessage);
        }
    
        public virtual ObjectResult<Nullable<int>> WSP_Insert_Updates(Nullable<int> document_ID, string updateUser)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("WSP_Insert_Updates", document_IDParameter, updateUserParameter);
        }
    
        public virtual int WSP_Insert_UpdatesData(Nullable<int> update_ID, string columnName, string originalData, string currentData)
        {
            var update_IDParameter = update_ID.HasValue ?
                new ObjectParameter("Update_ID", update_ID) :
                new ObjectParameter("Update_ID", typeof(int));
    
            var columnNameParameter = columnName != null ?
                new ObjectParameter("ColumnName", columnName) :
                new ObjectParameter("ColumnName", typeof(string));
    
            var originalDataParameter = originalData != null ?
                new ObjectParameter("OriginalData", originalData) :
                new ObjectParameter("OriginalData", typeof(string));
    
            var currentDataParameter = currentData != null ?
                new ObjectParameter("CurrentData", currentData) :
                new ObjectParameter("CurrentData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WSP_Insert_UpdatesData", update_IDParameter, columnNameParameter, originalDataParameter, currentDataParameter);
        }
    }
}
